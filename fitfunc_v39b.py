...
try:
    ...
    filename = ''
    SLURM_ID = 730#random.randint(0,100)
...
#    res_from_runs = main()
#        
    f = open(output_folder+'output_nsim%i_SLURM_ID%i_hes%i_fA%i_fV%i_q17%i.txt' % (nsim,SLURM_ID,int(new_hesitancy*100),int(source2.f_A*100),int(source2.f_V*100),int(q17*100)) ,'w')
